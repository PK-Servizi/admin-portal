        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. MOD730"
              className={cn(
                'w-full px-3 py-2 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-colors uppercase',
            ...
            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
              Unique code to identify the service (will be converted to uppercase)
            </p>
          </div>
